...
import static com.facebook.presto.common.RuntimeMetricName.GET_CANONICAL_INFO;
    ...
    private PlanRoot createLogicalPlanAndOptimize()
    {
        try {
            ...
            List<CanonicalPlanWithInfo> canonicalPlanWithInfos = getSession().getRuntimeStats().profileNanos(
                    GET_CANONICAL_INFO, () -> getCanonicalInfo(getSession(), plan.getRoot(), planCanonicalInfoProvider));
