...
public class PlannerUtils
{
    ...
    public static AggregationNode.Aggregation getIntermediateAggregation(AggregationNode.Aggregation originalAggregation, FunctionAndTypeManager functionAndTypeManager)
    {
    ...
    public static VariableReferenceExpression getVariableForIntermediateAggregation(
            AggregationNode.Aggregation aggregation,
            FunctionAndTypeManager functionAndTypeManager,
            VariableAllocator variableAllocator)
    {
        String functionName = functionAndTypeManager.getFunctionMetadata(aggregation.getFunctionHandle()).getName().getObjectName();
        FunctionHandle functionHandle = aggregation.getFunctionHandle();
        JavaAggregationFunctionImplementation function = functionAndTypeManager.getJavaAggregateFunctionImplementation(functionHandle);
        return variableAllocator.newVariable(aggregation.getCall().getSourceLocation(), functionName, function.getIntermediateType());
    }
